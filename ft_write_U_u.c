...
static int	ft_write_justify_size_U_u(t_env *arg, unsigned long long nbr)
{
...
static int	ft_write_justify_prc_U_u(t_env *arg, unsigned long long nbr)
{
...
static int	ft_write_prc_U_u(t_env *arg, unsigned long long nbr)
{
	if (arg->size > arg->precision.len)
	{
		ft_write_flag_spaces(arg->size, arg->precision.len);
